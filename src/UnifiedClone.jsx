...
export default function UnifiedClone() {
  ...
  const navLinks = [
    ...
    { name: "Submission", href: "submission.html" },
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              >
                <p>
                  ...
                  diversification, sustainable development, and the advancement
                ...
                <p>
                  ...
                  the latest developments in Mechanical and Aerospace
                  Engineering. With a particular emphasis on sustainability and
                  renewable energy, the conference seeks to address global
                  challenges through interdisciplinary engineering solutions.
                </p>
                <p>
            ...
            <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
              ...
              >
                ...
                <p className="text-justify leading-relaxed text-gray-700">
                  ...
                  <em> Fluids and Thermal Engineering </em> from July 2019 to
                  June 2025 — each with an intake of 20 students.
                </p>

                <p className="text-justify leading-relaxed text-gray-700">
                  Additionally, the department initiated its
                  <strong> Ph.D. programme </strong> in the academic year
                  2015–16, fostering advanced research and innovation in key
                  areas of
            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              >
                ...
                <p className="mt-4 text-lg text-gray-700">
                  ...
                  before the deadline. Abstract should have a minimum of 250
                  words and not more than 500 words.
                </p>
